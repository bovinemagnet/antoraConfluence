...
class AntoraConfluencePlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        publishTask.configure {
            ...
            hierarchyMode.set(extension.publish.hierarchy)
            versionMode.set(extension.publish.versionMode)
            createIndexPages.set(extension.publish.createIndexPages)
            uploadImages.set(extension.render.uploadImages)
            normalizeWhitespaceForDiff.set(extension.render.normalizeWhitespaceForDiff)
            failOnUnresolvedXref.set(extension.render.failOnUnresolvedXref)
            credentialsPresent.set(credentialsPresentProvider)
            fingerprintFile.set(extension.state.file)
